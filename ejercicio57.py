""" 
    ...
    Para multiplicar las dos matrices se debe multiplicar cada elemento de la primera
    fila de la primera matriz por cada elemento de la primera columna de la segunda matriz
